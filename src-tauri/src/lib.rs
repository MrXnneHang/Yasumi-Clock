...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            tauri_api::commands::reset_timer,
            tauri_api::commands::dismiss_rest_overlay,
            tauri_api::commands::adjust_classic_focus_duration,
            tauri_api::commands::select_timer_mode,
